...
// =========================================================================================
// Blind (Dummy) Implementation
// =========================================================================================
size_t Blind::write(uint8_t b) { return 1; }
void Blind::setCursor(uint8_t _x, uint8_t _y) {}
void Blind::cursor() {}
void Blind::noCursor() {}
void Blind::begin(uint8_t x, uint8_t y) {}
void Blind::noDisplay() {}
void Blind::createChar(uint8_t l, uint8_t glyph[]) {}
