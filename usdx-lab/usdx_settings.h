// usdx_settings.h - uSDX Plus Orange (producción, modular)
...
// (verificado variable a variable). Única excepción documentada: DIAG (este
// firmware no porta la suite de diagnóstico de arranque de legacy).
...
// =============================================================================
// VERSION (versión de producción; se muestra en el arranque)
// =============================================================================
#define FIRMWARE_VERSION "v2.0.0-lab"
...
// =============================================================================
// #define DIAG           1   // startup diagnostics (no portado; divergencia documentada)
...
// VFO / PERSISTENCIA
// =============================================================================
#define KEEP_BAND_DATA 1 // memoria de banda por frecuencia/modo (heredado de legacy)
