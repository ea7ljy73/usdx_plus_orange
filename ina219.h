...
#define INA219_CONFIG_BADCRES_12BIT_2S_1060US                                  \
  (0x0480) // 2 x 12-bit bus samples averaged together
#define INA219_CONFIG_BADCRES_12BIT_4S_2130US                                  \
  (0x0500) // 4 x 12-bit bus samples averaged together
#define INA219_CONFIG_BADCRES_12BIT_8S_4260US                                  \
...
#define INA219_CONFIG_BADCRES_12BIT_32S_17MS                                   \
  (0x0680) // 32 x 12-bit bus samples averaged together
#define INA219_CONFIG_BADCRES_12BIT_64S_34MS                                   \
